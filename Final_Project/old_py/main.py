...
parser.add_argument('--video', help='/home/huawei/anaconda3/openpose/1/test_out/11.mp4')
args = parser.parse_args()

# 导入相关模型
#estimator = load_pretrain_model('VGG_origin')
estimator = load_pretrain_model('mobilenet_thin')
action_classifier = load_action_premodel('Action/framewise_recognition.h5')#action classifier model
